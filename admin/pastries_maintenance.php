...
if (isset($_POST['update_product'])) {
    ...
    if ($update_query) {
        ...
        header('location:pastries_maintenance.php');
    } else {
...
<head>
    ...
    <title>Filipino Pastries Maintenance | kapecafé</title>
    ...
    <div class="container">
        ...
        <section class="display-product-table">
            ...
            <table>
                ...
                <tbody>
                    <?php
                    $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE category = 'Pastries'");
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="pastries_maintenance.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('are your sure you want to delete this?');"> <i class="fas fa-trash"></i> delete </a>
                                    <a href="pastries_maintenance.php?edit=<?php echo $row['id']; ?>" class="option-btn"> <i class="fas fa-edit"></i> update </a>
                                </td>
                            </tr>
        ...
        <section class="edit-form-container">
            ...
            ?>
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <a class="option-btn" href="pastries_maintenance.php" role="button"> Cancel </a>
