...
if (isset($_POST['update_product'])) {
    ...
    if ($update_query) {
        ...
        header('location:cakes_maintenance.php');
    } else {
...
<head>
    ...
    <title>Cakes Maintenance | kapecafé</title>
    ...
    <div class="container">
        ...
        <h1>Cakes</h1>
            ...
            <table>
                ...
                <tbody>
                    <?php
                    $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE category = 'Cakes'");
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="cakes_maintenance.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('are your sure you want to delete this?');"> <i class="fas fa-trash"></i> delete </a>
                                    <a href="cakes_maintenance.php?edit=<?php echo $row['id']; ?>" class="option-btn"> <i class="fas fa-edit"></i> update </a>
                                </td>
                            </tr>
        ...
        <section class="edit-form-container">
            ...
            ?>
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <a class="option-btn" href="cakes_maintenance.php" role="button"> Cancel </a>
