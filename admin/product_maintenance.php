...
<head>
    ...
    <title>All Product Maintenance | kapecafé</title>
                ...
                <tbody>
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="product_maintenance.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('are your sure you want to delete this?');"> <i class="fas fa-trash"></i> delete </a>
                                    <a href="product_maintenance.php?edit=<?php echo $row['id']; ?>" class="option-btn"> <i class="fas fa-edit"></i> update </a>
                                </td>
                            </tr>
